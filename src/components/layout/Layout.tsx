    ...
    <div className="flex min-h-screen">
      <aside className="hidden w-60 shrink-0 flex-col border-r border-slate-200 bg-white md:flex">
        <div className="px-5 py-5">
          <div className="text-lg font-semibold text-brand-700">退休财务规划</div>
          <div className="text-xs text-slate-400">{profile?.province ?? 'BC'}省 · 2026</div>
        </div>
        {profile && (
      ...
      <main className="flex flex-1 flex-col overflow-x-hidden">
        ...
        <footer className="px-6 py-4 text-center text-[11px] leading-relaxed text-slate-400">
          本工具的税率、政府福利等参数为近似估算，仅供规划参考，不构成税务、法律或投资建议。
          重大财务决定请咨询持牌会计师或理财顾问。
        </footer>
      </main>
    </div>
